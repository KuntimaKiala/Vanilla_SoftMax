...
if __name__ == '__main__' :
    ...
    data_handler = DataHandler(datasets=datasets.FashionMNIST,download=False, batch_size=700) 
    ...
    trainer = Trainer(model=model, epochs=100, learning_rate=0.001, momentum=0.89)
